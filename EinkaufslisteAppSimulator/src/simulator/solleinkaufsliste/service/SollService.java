...
public class SollService {
	...
	//finde den gr��ten Zahleintrag einer Liste (Verbrauchsablauf), der <= einer angegebenen Zahl (Einkaufzeitpunkt).
	...
	/**
	 * erstelle SollEinkaufslisten vor jedem Einkauf �ber ein Zeitraum in Tagen.
	 * Da es verkommen kann, das zum Zeitpunkt eines Einkaufs die Solleinkaufsliste leer ist, gibt diese Methode nur ausgef�llte sollEinkaufslisten
	 * @param persona
	 ...
	 * @return gibt Kauftagen und deren entsprechende SollEinkaufsliste zur�ck, wenn die SollEinkaufsliste nicht leer ist.
	 */
	...
	/**
	 * sortiere eine Liste, die keyListe von der solleinkaufslisteMap, so dass die Map-Werte �ber den Key sortiert 
